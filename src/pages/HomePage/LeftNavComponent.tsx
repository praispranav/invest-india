...
function LeftNavComponent() {
    return (
        <>
            ...
            <div className="left-nav-bottom-card row bg-white mt-4 pt-3 mx-0 pb-3 px-1">
                <h6 className="px-0 card-heading-left-bottom"> VIEW STARTUP ECOSYSTEM INSIGHTS OF INDIA</h6>
